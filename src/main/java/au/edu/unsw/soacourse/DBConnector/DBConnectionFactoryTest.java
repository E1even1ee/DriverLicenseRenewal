package au.edu.unsw.soacourse.DBConnector;
...
public class DBConnectionFactoryTest extends TestCase {
	 ...
	 */
	 ...
	 public void setUp() throws Exception {
         ...
         ref.add(new StringRefAddr("url", "jdbc:sqlite:/Users/Li/MySQLiteDB"));
         ref.add(new StringRefAddr("username", "li"));
         ref.add(new StringRefAddr("password", "123"));
         ic.bind("java:/comp/env/jdbc/MySQLiteDB", ref);
    }
